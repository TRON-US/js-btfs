...
# Full IPFS module
webpack --display none --config webpack.config.json complete-module.js complete-bundle.js
...
do
  ...
  webpack --display none --config webpack.config.json $moduledir/$module.js $moduledir/bundle.js
